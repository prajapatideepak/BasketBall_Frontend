...
function Login() {
    ...
    return (
        ...
        <div className='flex justify-center h-screen items-center lg:space-x-32 xl:space-52 2xl:space-x-48'>
            ...
            <div className=' 2xl:w-[27%] px-5 mt-4 sm lg:mt-0 '>
                <div className=' space-y-3  '>
                    <h1 className='text-3xl font-bold text-center uppercase text-[#ee6730]'>Login</h1>
                ...
                <div className='text-center mt-5 text-slate-500'>
                    ...
                    <Link to={"/register"}>
                        <span className='hover:text-black font-semibold cursor-pointer text-[#ee6730] px-2'>Create an account</span>
                    </Link>
                </div>
