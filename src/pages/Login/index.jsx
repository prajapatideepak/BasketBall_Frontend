...
function Login() {
  ...
  return (
    <div className="flex justify-center h-screen items-center  bg-white  lg:space-x-32 xl:space-52 2xl:space-x-48">
      <div className="img lg:w-[450px]  lg:h-[350px] xl:w-[500px] xl:h-[400px] 2xl:h-[625px] 2xl:w-[600px] hidden lg:block">
      ...
      <div className=" 2xl:w-[27%] px-5 mt-4 sm lg:mt-0 ">
        ...
        <form action="" className="space-y-3" onSubmit={handleSubmit}>
          <div className="space-y-5 py-4 ">
            <div className="space-y-2">
              ...
              <input
                ...
                onBlur={handleBlur}
                className="w-full rounded-md py-2 px-3 outline-non border border-slate-300 focus:outline-[#ee6730]"
              />
          ...
          <div className="py-1">
            <button
              type="submit"
              className="py-2  uppercase bg-[#ee6730] hover:shadow-none hover:border-[#ee6730] border-[#ee6730] border hover:bg-white hover:text-[#ee6730] duration-500 shadow-sm font-sans shadow-[#ee6730] px-20 rounded-md w-full text-white font-semibold text-base"
            >
              Submit
            </button>
          </div>
