...
function Tournamentregistration() {
    ...
    const validationSchema = Yup.object({
        ...
        referee_name: Yup.string().matches(/^[a-zA-Z]+$/, "Please enter only characters").min(2, "Coach name must be at least 2 characters").max(25, "Coach name should not be more than 25 characters"),
        referee_mobile: Yup.string().matches(/^[0-9]+$/, "Please enter only numbers").min(10, "Mobile number should be at least 10 digits").max(10, "Mobile number should be at least 10 digits"),
        sponsor_name: Yup.string().matches(/^[a-zA-Z]+$/, "Please enter only characters").min(2, "Sponsor name must be at least 2 characters").max(25, "Sponsor name should not be more than 25 characters"),
    })
                                ...
                                <div key={index} className="flex flex-col  items-center " >
                                        ...
                                        <div className="flex flex-col w-full">
                                            ...
                                            />
                                            {
                                                errors.referee_name && touched.referee_name
                                                    ?
                                                    <small className='text-red-600 mt-2'>{errors.referee_name}</small>
                                                    :
                                                    null
                                            }
                                        </div>
                                        <div className="flex flex-col w-full">
                                                ...
                                                onBlur={handleBlur} />
                                            {
                                                errors.referee_mobile && touched.referee_mobile
                                                    ?
                                                    <small className='text-red-600 mt-2'>{errors.referee_mobile}</small>
                                                    :
                                                    null
                                            }
                                        </div>
                                    ...
                                    {refereelist.length - 1 === index && (
                                        <div className="flex lg:justify-end items-center justify-center lg:items-end w-full" onClick={handleadd}>
                                            <div className="bg-slate-900 relative inline-flex items-center justify-center px-3 py-2 overflow-hidden text-white
                                        ...
                                        <div className="flex flex-col w-full">
                                            ...
                                            />
                                            {
                                                errors.sponsor_name && touched.sponsor_name
                                                    ?
                                                    <small className='text-red-600 mt-2'>{errors.sponsor_name}</small>
                                                    :
                                                    null
                                            }
                                        </div>
