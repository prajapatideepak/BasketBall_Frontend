...
function TeamRegister() {
  ...
  const allteams = [
    ...
    },
    {
      ...
      players: [
        { id: 1, name: 'Sadikali karadiya', position: 'point guard', age: 24, jersey_no: 10 },
        { id: 2, name: 'Deepak Prajapati', position: 'center', age: 26, jersey_no: 11 },
        { id: 3, name: 'Sadikali karadiya', position: 'point guard', age: 25, jersey_no: 12 },
      ],
    },
  ]
  ...
  const handleSelectTeam = (e) => {
    ...
    let AllTeams = Teams.map((team) => team.team_id == id ? { ...team, isSelect: select } : team);
    ...
    <section className='min-h-screen'>
      <div className="mx-auto px-10 py-5 sm:px-20 sm:py-12 md:px-20 md:py-10 lg:px-24 xl:px-28 2xl:px-32">
        <div className='flex justify-center items-center py-5 '>
          ...
          <p className='text-base xs:text-xl sm:text-2xl lg:text-4xl  font-bold text-black '>Champion League</p>
        </div>
                    ...
                    Teams.map((team, index) => {
                      return (
                        <div key={index}
                          ...
                          className={` ${team.isSelect == true ? "bg-[#ee6730] text-white" : "bg-white"} flex items-center xl:w-1/4 2xl:w-1/5 space-x-5 xl:space-x-2 justify-start font-normal px-5 py-5 lg:py-6 
          ...
          <div className='w-full'>
            ...
            <div className='md:px-5 py-2 rounded-md my-5 px-2 '>
              <ul className='flex px-2 2xl:px-10 justify-between bg-gray-300 py-[10px] rounded-md text-black font-medium '>
                ...
                <li className='w-10 text-center text-xs md:text-[12px] lg:text-base 2xl:text-[16px] '>Sr.No</li>
                <li className='w-32 text-center text-xs md:text-[12px] lg:text-base 2xl:text-[16px] '>Name</li>
                <li className='w-10 text-center text-xs md:text-[12px] lg:text-base 2xl:text-[16px] '>Age</li>
                <li className='w-32 text-center text-xs md:text-[12px] lg:text-base 2xl:text-[16px] '>Captain</li>
              </ul>
