...
function TeamProfileDetail() {
  ...
  const rojki = useGetTeamDetailQuery({ teamId: 12 });
  console.log(rojki);
        ...
        <div>
          <div className="team-logo-container flex justify-center items-center rounded-full">
            <img
              ...
              className="rounded-full border-2 shadow-lg w-20 xs:w-24 sm:w-32"
            />
          </div>
                    ...
                    <div className="border-2 border-orange-100 px-2 py-2 rounded-lg bg-white font-medium">
                      <p>
                        {teamDetails.assistant_coach_mobile == ""
                          ? "--"
                          : isPublicView
                          ? `XXXXXX${teamDetails.assistant_coach_mobile.slice(
                              5,
                              9
                            )}`
                          : teamDetails.assistant_coach_mobile}
                ...
                <div className="flex flex-col text-xs xs:text-sm sm:text-base">
                  ...
                  <div
                    className={`border-2 border-orange-100 px-2 py-2 rounded-lg bg-white ${
                      isPublicView ? "h-32 lg:h-[328px]" : "h-32 lg:h-[328px]"
                    } overflow-y-auto`}
                  >
