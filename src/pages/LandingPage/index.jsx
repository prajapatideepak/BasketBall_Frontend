        ...
        <div className="bg-gray-50 h-screen xl:px-10 py-5 md:py-10 lg:py-0 xl:py-0 flex xl:items-center justify-between ">
            <div className=" flex flex-col xl:flex-row justify-center xl:justify-between items-center  md:items-start   ">
                ...
                flex flex-col justify-start items-center sm:items-start md:items-start lg:items-start  ">
                    <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl text-black xl:text-8xl font-semibold 2xl:text-[115px] font-serif uppercase">Corporate</h1>
                    ...
                    <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-8xl text-black 2xl:text-[115px] font-semibold font-serif uppercase ">League</h1>
                ...
                <div className="img absolute bottom-0 sm:bottom-0 md:bottom-0 right-0 xl:top-32 2xl:top-24 2xl:right-10  h-[280px] w-[350px] sm:h-[400px] sm:w-[380px] md:h-[450px] md:w-[450px] lg:h-[450px] lg:w-[450px] xl:h-[550px] xl:w-[550px] 2xl:h-[500px] 2xl:w-[500px]  ">
