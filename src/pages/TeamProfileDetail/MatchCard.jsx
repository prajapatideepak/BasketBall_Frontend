...
function MatchCard({match}) {
  ...
  return (
    <>
      <div className="relative min-w-[320px] sm:min-w-[350px] md:min-w-[380px] max-w-[440px] h-[190px] sm:h-[200px] md:h-[230px] border-0 hover:border-2 hover:border-gray-400 hover:border-dashed group">
        <div className="absolute transition-all duration-300 ease-in-out cursor-pointer top-[-2px] left-[-2px] w-full h-full group-hover:left-[-10px] group-hover:top-[-10px] hover:left-[-10px] hover:top-[-10px] p-5 bg-white shadow-lg flex flex-col justify-center items-center" onClick={handleClick}>
