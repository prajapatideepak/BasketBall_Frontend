...
const News = () => {
  ...
  return (
    ...
    {loader ? <Loader/> :   <><div className="flex  relative justify-center items-center text-[#ee6730] p-2 space-x-3 font-bold text-3xl">
              <h1 className="text-black underline"> News</h1>
              <GiBasketballBall className="animate-bounce	 text-[#ee6730] " />
          </div><div className="mx-6 lg:mx-12 pt-5">
