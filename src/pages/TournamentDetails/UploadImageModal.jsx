...
export default function UploadImageModal({open, handleOpen}) {
    ...
    return (
        <div id="image-modal" tabIndex="-1" aria-hidden="true" className={`${open ? '' : 'hidden'} fixed grid place-items-center top-auto bottom-auto left-0 right-0 z-[9999] w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-modal md:h-full bg-white`} style={{backgroundColor: "rgba(1, 1, 1, 0.7)"}}>
            <div className="relative w-full h-full mx-auto max-w-md md:h-auto">
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div className="px-6 py-6 lg:px-8">
                        <h3 className="mb-4 text-xl font-medium text-gray-900 dark:text-white">Upload Image</h3>
