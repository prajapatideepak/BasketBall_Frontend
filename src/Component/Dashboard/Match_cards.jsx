...
function Match_cards({ id, day, date, is_live, time, team_1_score, first_team, secound_team, team_2_score, won_team, F_logo, s_logo, tournament, location, tournament_logo }) {
