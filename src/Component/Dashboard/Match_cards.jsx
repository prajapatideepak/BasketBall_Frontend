  ...
  return (
    ...
    hover:scale-105 duration-500 transition-all group rounded-lg">
      <div className="absolute transition-all duration-300 ease-in-out cursor-pointer w-full h-full  shadow-lg flex flex-col justify-center items-center rounded-lg overflow-hidden " >
        ...
        <div className=' bg-black/5 text-white  flex justify-between items-center px-10 h-[100%] w-full absolute rounded-lg '>
          <div className="t_1  flex flex-col justify-center items-center gap-2 mb-6 ">
            <h1 className='text-white font-bold uppercase'>{first_team}</h1>
          ...
          <div className="t_2 flex flex-col justify-center items-center gap-2 mt-6 ">
            <div className="w-20 h-20 md:w-24 md:h-24  rounded-full shadow-lg">
              <img src={s_logo} className="object-contain rounded-full w-full h-full bg-white" alt="" />
            </div>
            <h1 className='text-white font-bold uppercase'>{secound_team}</h1>
          </div>
        </div>
