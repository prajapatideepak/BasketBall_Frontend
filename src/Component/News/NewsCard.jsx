  ...
  return (
    <div className="w-full cursor-pointer relative shadow-2xl rounded  ">
      ...
      >
        ...
        <div
          className={`absolute overflow-hidden  rounded-b-2xl flex flex-col  space-y-0 md:space-y-0 justify-end w-full  bottom-0  left-0 text-white bg-gradient-to-l hover:h-full  from-transparent via-black  to-gray-900 px-2  py-2 ${
            news.small ? "lg:px-2 lg:pt-1" : "lg:px-8 lg:pt-4"
          ...
          <div className="py-1 lg:py-3  leading-relaxed">
            <h1
              className={`text-sm md:text-lg  ${
                news.small ? "lg:text-sm" : "lg:text-lg"
