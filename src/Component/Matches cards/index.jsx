  ...
  return (
    <>
      <div className="relative min-w-[260px] xs:min-w-[320px] sm:min-w-[350px] md:min-w-[380px] max-w-[440px] h-[190px] sm:h-[200px] md:h-[230px] border-0 hover:border-2 hover:border-gray-400 hover:border-dashed group rounded-lg">
        <div className="absolute transition-all duration-300 ease-in-out cursor-pointer top-[-2px] left-[-2px] w-full h-full group-hover:left-[-10px] group-hover:top-[-10px] hover:left-[-10px] hover:top-[-10px] bg-white shadow-lg p-2 md:p-5 rounded-lg" onClick={handleClick}>
          <div className='flex  items-center w-full cursor-pointer'>
            ...
            </div>
            {
              match.is_live === 1
                ...
                <div className='bg-red-500 flex items-center absolute right-0 top-0 cursor-pointer pr-2 px-1 rounded-sm text-white  '>
