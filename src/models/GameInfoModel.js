...
export const GameInfoSchema = Yup.object({
  ...
  jersey_no: Yup.number().min(0).max(999).required("Please Enter Your Jersey Number ").integer(),
  about: Yup.string().required("Please Write Something about Yourself and Your Experience "),
});
